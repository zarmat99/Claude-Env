...
## (e.g. IdUtils.is_well_formed("item_iron_sword")). Conventions: PROJECT_MEMORY.md section 10.
...
## True if `id` starts with the given type prefix, e.g. has_type_prefix("item_iron_sword", "item").
