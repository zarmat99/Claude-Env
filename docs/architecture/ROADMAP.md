...
- **Status 2026-06-28**: complete. Production dialogue actions, branching conventions,
  multi-stage branch regression, in-game Branch Tester probe, and Quest Debug overlay are live.
